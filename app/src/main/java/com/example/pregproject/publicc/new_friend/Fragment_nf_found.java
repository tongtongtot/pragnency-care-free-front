package com.example.pregproject.publicc.new_friend;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_c_apply_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(nowuser.friendlist!=null&&nowuser.friendlist.contains("#"+recid+"#")){
                    ...
                    final StringRequest request = new StringRequest(Request.Method.POST, url,  new Response.Listener<String>() {
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            map.put("sendid", String.valueOf(nowuser.user_id));
                            map.put("applytype", String.valueOf(1));
                            map.put("postid", String.valueOf(nowuser.user_id));
                            map.put("data", msg);
