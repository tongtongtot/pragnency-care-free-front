...
import pregproject.pregproject.forum.Fragment_forum;
import pregproject.pregproject.professor.Fragment_professor;
import pregproject.pregproject.publicc.Fragment_public;
import pregproject.pregproject.publicc.notification.Applymsg;
                         ...
                         try {
                             ...
                             final StringRequest request = new StringRequest(Request.Method.POST, url,  new Response.Listener<String>() {
                                 ...
                                 protected Map<String, String> getParams() throws AuthFailureError {
                                     ...
                                     map.put("recid",String.valueOf(MainActivity_login.nowuser.user_id));
                                     return map;
                                 }
                             };
